...
LSM:Register("statusbar",	"Melli", 			[[Interface\AddOns\ElvUI\media\textures\Melli.tga]]) --schism
LSM:Register("statusbar",	"MelliDark", 		[[Interface\AddOns\ElvUI\media\textures\MelliDark.tga]]) --schism
LSM:Register("statusbar",	"BuiOnePixel", 		[[Interface\AddOns\ElvUI\media\textures\BuiOnePixel.tga]]) --schism
